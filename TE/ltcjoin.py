...
api_id = 2044820
api_hash = '39dd7bd70b7e95b187376c0241d421e6'
...
async def main():
	print(Fore.YELLOW  + '__      _____ _    ___ ___  __  __ ___ ')
	print(Fore.YELLOW  + '\ \    / / __| |  / __/ _ \|  \/  | __|')
	print(Fore.YELLOW  + ' \ \/\/ /| _|| |_| (_| (_) | |\/| | _| ')
	print(Fore.YELLOW  + '  \_/\_/ |___|____\___\___/|_|  |_|___|\n' + Fore.RESET)
	print(Fore.GREEN + '    -   SUSCRIBETE AL CANAL HITENKEI   -   \n' + Fore.RESET)
